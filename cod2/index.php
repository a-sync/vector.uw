...
##########################
// config ###########################################################
$name='CoD2-Cfg.tk';		// title of the site
$root='';					// directory to list (same as the script file by default)
$ignoredf1='index.php';				// 1. ignored file or directory/file (eg.: 'index1.html' or 'files/me.jpg' etc.)
$ignoredf2='';				// 2. -"-
$ignoredf3='';				// 3. -"-
$ignoredt1='';				// 1. ignored file type (eg.: 'php' etc.)
$ignoredt2='';				// 2. -"-
$ignoredt3='';				// 3. -"-
$ignoredd1='vec';				// 1. ignored directory or directory/directory (eg.: 'files' or 'files/secret' etc.)
$ignoredd2='';				// 2. -"-
$ignoredd3='';				// 3. -"-
...
$bottom='&copy; 2004-2006 <a href="mailto:info @ cod2-cfg . tk">Vector Akashi</a><br><br><a href="http://english-84350831477.spampoison.com"><img src="http://pics3.inxhost.com/images/sticker.gif" border="0" width="80" height="15"></a><script type="text/javascript" language="javascript">var sc_project=1056612;var sc_invisible=1;var sc_partition=6;var sc_security="41457862";var sc_remove_link=1;</script><script type="text/javascript" language="javascript" src="http://www.statcounter.com/counter/counter.js"></script><noscript><img src="http://c7.statcounter.com/counter.php?sc_project=1056612&amp;java=0&amp;security=41457862&amp;invisible=1" alt="" border="0"></noscript>';	// stuff under the lister (html)
// css styles #######################################################
$burl=$_SERVER['PHP_SELF'];
$css=<<<EOT
...
else
{
	...
	if(!$incl)print'<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><html><head><link rel="shortcut icon" type="image/png" href="data:image/png;base64,'.$imgicon.'"><link rel="icon" type="image/png" href="data:image/png;base64,'.$imgicon.'"><title>'.$name.'</title><style type="text/css">'.$css.'</style><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-2"></head><body>';
...
?><!-- Vector Lister 1.6 by: vector @ cod2-cfg .tk -->